...
from .tools import discover_website, extract_website_content, search_company_news
from .prompt import get_research_prompt
from .parser import get_research_parser
...
def research_node(state: Dict[str, Any], config: RunnableConfig = None) -> Dict[str, Any]:
    ...
    website_url = discover_website(company_domain)
    ...
    # Using ChatOpenAI as default. This can be configured via environment or dependency injection.
