...
class CompanyResearch(BaseModel):
    """
    Pydantic schema representing the structured research information about a company.
    This schema is used to validate the output of the LLM extraction.
    """
    ...
    description: Optional[str] = Field(default=None, description="A brief description of what the company does")
