...
def generate_report():
    report = """# Apollo-IO Architecture Validation Report
...
"""
    os.makedirs("backend/validation/reports", exist_ok=True)
    with open("backend/validation/reports/architecture_audit.md", "w") as f:
        f.write(report)
    print("Report generated at backend/validation/reports/architecture_audit.md")
    print("\nReport Content:\n")
    print(report)
